...
import {CurrentUserContext} from "./components/current-user-context-wrapper/CurrentUserContext";
...
class App extends Component {
  render() {
    return (
// to+do: обвернуть в CurrentUserContext наше приложение, как value положить переменную user из констант
       <CurrentUserContext>
